...
if (isset($_POST["id_beneficiario"])) {
    ...
    $result = mysql_query("SELECT A.id_agenda as id_agenda, A.id_beneficiario as id_beneficiario, A.fecha_agendada as fecha_agendada, A.numero_consulta as numero_consulta, A.id_medico as id_medico, A.turno as turno,
						   ...
						   FROM agenda A, beneficiarios B, consultorios C, medicos M WHERE A.id_beneficiario = $id_beneficiario and B.id_beneficiario = $id_beneficiario and A.id_medico = M.id_medico and M.id_oficina = C.id_oficina");
